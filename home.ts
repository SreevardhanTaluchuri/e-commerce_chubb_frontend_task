...
const setUI = () => {
    const parentElement = document.getElementById("products") as HTMLDivElement;
    (window.localStorage.getItem("categories") || "").split(",").forEach(item => {
        ...
        addProductsInUI(categoryData , categoryDiv);
...
const changeQuantity = (event) => {
    ...
    if(found.quantity == 1){
        ...
        (document.getElementById("products") as HTMLDivElement).innerHTML = "";
        setUI();
    }else{
...
const addProductsInUI = (productsData,appendTo) => productsData?.forEach((item , index) => {
...
const addToCart = (event) =>{
    ...
    const cartBtn = document.getElementById(event.target.id) as HTMLButtonElement;
    cartBtn.innerHTML="";
    ...
    const decBtn = document.createElement("button");
        ...
        const quanitityText = document.createElement("p") as HTMLElement;
...
const setProductsInCategory = () => {
    ...
    const categoryDiv = document.getElementById("product") as HTMLElement;
